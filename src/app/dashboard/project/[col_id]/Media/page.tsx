                        ...
                        <>
                            {
                                media && media.map((m, index) => (
                                    <tr key={index} className="hover:bg-gray-700">
                                        ...
                                        <td className="px-4 py-2 border-b border-gray-600">{m.key}</td>
                                        <td className="px-4 py-2 border-b border-gray-600">{m.title}</td>
                                        <td className="px-4 py-2 border-b border-gray-600">{m.content}</td>
                                        <td className="px-4 py-2 border-b border-gray-600">{m.time}</td>
                                        ...
                                        <td
                                            ...
                                            {openIndex === index && (
                                                <div className="absolute right-0 mt-2 w-24 bg-white text-black rounded shadow-lg z-10">
                                                    <button
                                                        onClick={(e) => handleShowFile(e, m.collection_id, m.key)}
                                                        className="block w-full text-left px-4 py-2 hover:bg-gray-200"
                                                    >
                                                        View
                                                    </button>
                                                    <button
                                                        onClick={() => handleDeleteFile(m.id, m.key)}
                                                        className="block w-full text-left px-4 py-2 hover:bg-gray-200"
                                                    >
                                                        Delete
                                                    </button>
